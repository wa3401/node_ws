...
message(STATUS "lab7: 1 messages, 0 services")

set(MSG_I_FLAGS "-Ilab7:/home/williamanderson/catkin_ws/src/lab7/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/williamanderson/catkin_ws/src/lab7/msg/test.msg" NAME_WE)
add_custom_target(_lab7_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lab7" "/home/williamanderson/catkin_ws/src/lab7/msg/test.msg" ""
)
...
_generate_msg_cpp(lab7
  "/home/williamanderson/catkin_ws/src/lab7/msg/test.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lab7)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lab7\")")
  # install generated code
  install(
